...
# for FOCAL_BAT in range(1, 2):
OUTPUT_DIR = f"./dump_files/10bats_selfecho_vs_other/{FOCAL_BAT}/"
received_sounds_sorted_by_time = read_data_per_simulation_per_bat_received(OUTPUT_DIR)
...
for frame in received_sounds_sorted_by_time[2:3]:
