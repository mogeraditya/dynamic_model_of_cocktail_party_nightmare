...
class Bat:
    ...
    def decide_next_direction(self, detected_sound_objects):
        ...
        grid_for_current_ipi, grid_row_labels, grid_column_labels = (
            convert_detected_sounds_into_grids(detected_sound_objects)
        )
        ...
        grids_to_consider_for_direction_change = (
            self.memory_window_to_store_grids.copy()
        )
        ...
        if cell_index_to_respond_to is None:
            ...
            next_direction = given_time_and_angle_return_direction(
                time_delay_of_activated_cell, angle_of_activated_cell
            )
