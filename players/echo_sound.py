...
class EchoSound:
    def __init__(self, parameters_df, origin, creation_time, emitter_id, initial_spl, parent_creation_time, reflection_count):
        ...
        self.max_radius = self.parameters_df['SOUND_SPEED'] * self.parameters_df['CALL_DURATION']
    ...
    def update(self, current_time):
        ...
        self.current_radius = self.parameters_df['SOUND_SPEED'] * elapsed
    ...
    def contains_point(self, point):
        ...
        return distance <= self.current_radius and distance >= max(0, self.current_radius - self.parameters_df['SOUND_DISK_WIDTH'])
    
    def create_echo(self, point, current_time, normal):
        if (self.has_reflected or 
            self.reflection_count >= self.parameters_df['MAX_REFLECTIONS']):
            return None
