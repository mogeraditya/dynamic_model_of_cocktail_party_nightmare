...
class Bat:
    ...
    def __init__(self, parameters_df):
        ...
        self.speed = self.parameters_dict['BAT_SPEED']
        self.time_since_last_call = random.uniform(0, 1/self.parameters_dict['CALL_RATE'])
    ...
    def _update_movement(self, time_elapsed):
        ...
        if random.random() < self.parameters_dict['PROPENSITY_TO_CHANGE_DIRECTION']:
    ...
    def _emit_sounds(self, time_elapsed, current_time, sound_objects):
        ...
        call_interval = 1.0 / self.parameters_dict['CALL_RATE']
    ...
    def _detect_sounds(self, current_time, sound_objects):
        for sound in sound_objects:
            ...
            if sound.current_spl< self.parameters_dict['MIN_DETECTABLE_SPL']:
                continue
