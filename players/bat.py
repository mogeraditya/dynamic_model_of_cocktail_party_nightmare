...
class Bat:
    ...
    def __init__(self):
        ...
        self.time_since_last_call = random.uniform(0, 1/Constants.CALL_RATE)
    ...
    def _update_movement(self, time_elapsed):
        ...
        if random.random() < Constants.PROPENSITY_TO_CHANGE_DIRECTION:
    ...
    def _emit_sounds(self, time_elapsed, current_time, sound_objects):
        ...
        call_interval = 1.0 / Constants.CALL_RATE
    ...
    def _detect_sounds(self, current_time, sound_objects):
        for sound in sound_objects:
            ...
            if sound.current_spl<Constants.MIN_DETECTABLE_SPL:
                continue
