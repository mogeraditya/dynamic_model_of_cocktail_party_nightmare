...
from modified_simulation_positive_control import ModifiedSimulationPositiveControl
...
def run_one_instance_of_simulation(
    ...
    make_dir(output_dir)
    sim = ModifiedSimulationPositiveControl(parameter_df, output_dir)
    sim.run()
...
if __name__ == "__main__":
    ...
    N_RUNS = 10  # Number of iterations per parameter set
    DATA_STORAGE_DIR = (
        r"./group_experiment_positive_control_1/"  # Base output directory
    )
