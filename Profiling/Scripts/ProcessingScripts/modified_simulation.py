...
if __name__ == "__main__":
    ...
    for jammer_resolution in jammer_resolutions:
        OUTPUT_DIR = f"./Profiling/Data/IntermediateData/profiling_{jammer_resolution}/"
        PARAMETER_FILE_DIR = r"./Profiling/Data/InputData/common_parameters.csv"

        PARAMETER_DF = load_parameters(PARAMETER_FILE_DIR)
        bat_locations_dir = "./Profiling/Data/InputData/bat_start_positions.csv"
        ...
        df.to_csv("./Profiling/Data/AnalysisData/profiling_output.csv")
