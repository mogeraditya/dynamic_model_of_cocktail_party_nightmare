...
def compute_collision_rate(bat_positions):
    ...
    for position_frame in bat_positions:
        ...
        for bat in position_frame:
            if bat[0] >= 4 - 0.125 or bat[0] <= 0.125:
                count_collisions += 1
            elif bat[1] >= 4 - 0.125 or bat[1] <= 0.125:
                count_collisions += 1
...
def time_spent_in_collision(bat_positions):
    ...
    for position_frame in bat_positions:
        ...
        for bat in position_frame:
            if bat[0] >= 4 - 0.125 or bat[0] <= 0.125:
                count_collisions += 1
            elif bat[1] >= 4 - 0.0124 or bat[1] <= 0.125:
                count_collisions += 1
...
def individual_collision_rate(bat_positions):
    ...
    for bat in range(0, number_of_bats):
        for position_frame in bat_positions:
            # for bat in position_frame:
            if position_frame[bat][0] >= 4 - 0.125 or position_frame[bat][0] <= 0.125:
                count_collisions += 1
            elif (
                position_frame[bat][1] >= 4 - 0.0124 or position_frame[bat][1] <= 0.125
            ):
                count_collisions += 1
